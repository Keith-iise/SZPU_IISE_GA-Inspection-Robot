...
# from Camera.PixelType_const import *
# from PixelType_header import *

# MvCamCtrldll = ctypes.cdll.LoadLibrary(os.getenv('MVCAM_COMMON_RUNENV') + "/64/libMvCameraControl.so")
if __name__ == 'MvCameraControl_class':

    so_file_path = r"./lib/libMvCameraControl.so"
else:
    so_file_path = r"./Camera/lib/libMvCameraControl.so"
MvCamCtrldll = ctypes.cdll.LoadLibrary(so_file_path)
